      ...
      <div className="container" style={{backgroundColor:'whitesmoke'}}>
        ...
        <div className="indexInfo" style={{display:'flex', justifyContent:'space-evenly', alignItems: 'center', flexGrow:'1'}}>
          ...
          <div className="infoText" style={{alignContent: 'center', padding: '10pt', backgroundColor: 'white', opacity: '1', width:'600px', borderRadius: '5pt' }}>
            <div>OUR MISSION</div>
            <p>Little Brothers - Friends of the Elderly is a national network of non-profit volunteer-based organizations committed to relieving isolation and loneliness among the elderly. We offer to people of goodwill the opportunity to join the elderly in friendship and celebration of life.</p>
          </div>
        </div>  
      </div>
